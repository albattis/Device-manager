function nev() {
    ...
    nev.innerHTML="";
    nev.innerHTML="<form method='post' action=''><input type='text' name='nev' id='nev'><button type='submit'>Kész</button> </form>";
}
function processor(){
...
processor.innerHTML="<form method='post' action=''>" +
    ...
    "<button type='submit'>Kész</button> </form>";
}
...
function videokartya(){
    ...
    videokartya.innerHTML="<form method='post' action=''><input type='text' name='videokartya' id='videokartya'><button type='submit'>Kész</button> </form>";
}
...
function csatlakozo(){
 ...
 cst.innerHTML="<form method='post' action=''><label for=\"usb\">USB &nbsp;</label><input type=\"checkbox\" name=\"usb\" id=\"usb\"><label for=\"usbc\">&nbsp USB-C&nbsp;</label><input type=\"checkbox\" name=\"usbc\" id=\"usbc\">\n" +
     ...
     "                        <label for=\"mikrofon\">&nbsp Mikrofon &nbsp;</label><input type=\"checkbox\" name=\"mikrofon\" id=\"mikrofon\"><label for=\"rj45\">&nbsp RJ45 &nbsp;</label><input type=\"checkbox\" name=\"rj45\" id=\"rj45\"><button type='submit'>Kész</button></form>";
}
...
function hiba(){
  ...
  hiba.innerHTML="";
  hiba.innerHTML="<form method='post' action=''><input type='text' name='hiba' id='hiba'><button type='submit'>Kész</button> </form>";
